    ...
    return (
        <div className="container mx-auto p-4 md:p-8 space-y-8 animate-in min-h-screen pb-20">
            ...
            {orders.length === 0 && !error ? (
                <div className="flex flex-col items-center justify-center py-20 bg-card rounded-2xl border border-dashed border-border text-center shadow-sm">
                    ...
                    <Button asChild size="lg" className="rounded-xl shadow-lg shadow-primary/25 text-white">
                        <Link href="/products">
                            Start Shopping
                        </Link>
                    </Button>
